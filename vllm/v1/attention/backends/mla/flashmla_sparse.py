...
class FlashMLASparseMetadataBuilder(
    ...
    def __init__(
        ...
        # The indexer's topk buffer is widened for kpool paging (see
        # sparse_attn_indexer_kpool): topk + (kpool-1), 128-aligned. The
        # physical reuse buffer must match that width or the convert
        # kernel's output-shape assert fires under kpool>1.
